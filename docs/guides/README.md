...
Operational guides for working with this workspace. Separate from `docs/apps/` and `docs/features/`, which are product specs (PRDs/GDDs) for what you're building.
